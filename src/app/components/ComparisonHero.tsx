    ...
    return (
        <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
                <h1 className="text-3xl md:text-5xl font-bold text-black">Product Comparison</h1>
                <nav className="text-sm md:text-base mt-2">
                    <span className="text-gray-700 hover:text-gray-900 cursor-pointer">Home / Product Comparison</span>
                </nav>
            </div>
        </div>
    )
